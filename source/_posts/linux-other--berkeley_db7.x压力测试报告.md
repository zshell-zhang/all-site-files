...
## **控制变量测试计划**
在本测试计划内使用的收集器是 ParNew + CMS 的组合, 配置如下:
``` bash
...
|:-------------------------------:|:--------------:|:--------------:|:--------------:|:--------:|
|RT (min/mean/median/P90/max) (ms)|6/85/73/122/1461|6/87/75/128/1708|6/88/75/125/3354|ab timeout|
|error/timeout                    |0               |0               |0               |/         |
...
|metrics \ je.maxMemoryPercent    |5%             |10%            |20%            |30%|
|:-------------------------------:|:-------------:|:-------------:|:-------------:|:-:|
|RT (min/mean/median/P90/max) (ms)|9/24/24/29/1030|8/23/24/26/1038|8/22/21/27/1218|/  |
|error/timeout                    |2              |2              |5              |/  |
...
|metrics \ je.maxMemoryPercent    |5%             |10%            |20%            |30%|
|:-------------------------------:|:-------------:|:-------------:|:-------------:|:-:|
|RT (min/mean/median/P90/max) (ms)|8/34/26/28/4529|6/32/25/28/4804|6/25/23/27/1073|/  |
...
|metrics \ je.maxOffHeapMemory    |512m            |1g              |10g             |20g             |
|:-------------------------------:|:--------------:|:--------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/85/73/122/3173|7/83/72/117/1714|6/87/75/128/1708|6/89/76/131/3074|
...
|metrics \ je.maxOffHeapMemory    |512m           |1g            |10g             |20g          |
|:-------------------------------:|:-------------:|:-------------:|:-------------:|:-----------:|
|RT (min/mean/median/P90/max) (ms)|9/23/22/25/1030|8/23/22/25/1225|8/23/24/26/1038|823/23/26/441|
...
|metrics \ je.maxOffHeapMemory    |512m           |1g             |10g            |20g            |
|:-------------------------------:|:-------------:|:-------------:|:-------------:|:-------------:|
|RT (min/mean/median/P90/max) (ms)|6/26/24/28/1029|6/26/24/27/1342|6/32/25/28/4804|6/26/23/27/1431|
...
|metrics \ -Xmx                   |10g             |20g             |25g             |30g             |
|:-------------------------------:|:--------------:|:--------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/83/70/123/3092|6/86/74/123/3140|6/87/75/128/1708|6/94/80/138/3101|
...
|metrics \ -Xmx                     |10g             |20g             |25g             |30g               |
|:---------------------------------:|:--------------:|:--------------:|:--------------:|:----------------:|
|RT (min/mean/median/P90/max) (ms)  |9/22/22/25/2819 |8/22/22/25/1077 |8/23/24/26/1038 |10/22/22/25/1429  |
...
|metrics \ -Xmx                   |10g             |20g             |25g             |30g            |
|:-------------------------------:|:--------------:|:--------------:|:--------------:|:-------------:|
|RT (min/mean/median/P90/max) (ms)|6/27/25/28/1195 |6/27/25/29/1264 |6/32/25/28/4804 |6/28/25/28/1344|
...
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/17/15/24/755  |6/17/15/24/1015 |
|error/timeout                    |0               |0               |
...
|metrics \ version                |6.4.25          |7.4.5           |
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/7/7/8/1077    |6/7/7/8/1130    |
|error/timeout                    |2               |2               |
...
|metrics \ version                |6.4.25          |7.4.5           |
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/8/7/8/510     |6/8/7/8/1068    |
|error/timeout                    |8               |2               |
|stdev/bias                       |9.2             |12.0            |
...
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/87/75/128/1708|ab timeout      |
|error/timeout                    |0               |/               |
|stdev/bias                       |72.0            |/               |
|YGC/YGCT (s)                     |14/4.397        |/               |
|FGC/FGCT (s)                     |0/0             |/               |
...
|metrics \ collector              |CMS             |G1              |
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|8/23/24/26/1038 |/               |
|error/timeout                    |2               |/               |
|stdev/bias                       |17.8            |/               |
|YGC/YGCT (s)                     |6/0.963         |/               |
|FGC/FGCT (s)                     |0/0             |/               |
...
|metrics \ collector              |CMS             |G1              |
|:-------------------------------:|:--------------:|:--------------:|
|RT (min/mean/median/P90/max) (ms)|6/32/25/28/4804 |/               |
|error/timeout                    |10907           |/               |
|stdev/bias                       |29.8            |/               |
